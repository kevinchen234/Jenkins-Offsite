class OffSiteRequest < ActiveRecord::Base
  ...
  attr_accessible :hostname, :hostname_in_use, :arachne_or_socrates, :off_site_ip, :sponsoring_department, 
    ...
    :campus_buyer_id, :meets_ctc_criteria, :ext_circumstance_ids, :other_ext_circumstances
