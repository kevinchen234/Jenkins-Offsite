...
# Determines of user table entries are automatically created after a user authenticates.
# Default behaviour is false.  Uncomment below config to change default behaviour
# UCB::Rails::Security::CASAuthentication.auto_create_authenticated_users = true
